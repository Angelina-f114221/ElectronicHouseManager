...
public class Company extends BaseEntity {
   ...
   private Set<Building> buildings;
    ...
    // OneToMany mappedBy company означава, че имаме водеща страна на връзката, която е там, където е външният ключ. имам колекция, защото компанията трябва да пази много служители. задължително в колекцията се използва сет, защото сега сме в company страната, а от другата страна са служителите. те се различават по уникален начин, така че колекцията трябва да има вградения механизъм да ги различава по естествен начин. имаме one company - many employees и many-to-one от страна на служителя. външният ключ, идващ от компанията, ще бъде в employee. Тази анотация/връзка е част от jakarta persistence layer. по този начин казвам, че employee знае за company и company знае за employee.
